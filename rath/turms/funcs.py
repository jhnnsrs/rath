...
def execute(operation: TurmsOperation, variables: Dict[str, Any], rath: Optional[Rath] = None) -> BaseModel:
...
async def aexecute(operation: TurmsOperation, variables: Dict[str, Any], rath: Optional[Rath] = None) -> BaseModel:
...
def subscribe(operation: TurmsOperation, variables: Dict[str, Any], rath: Optional[Rath] = None) -> Iterator[BaseModel]:
...
async def asubscribe(operation: TurmsOperation, variables: Dict[str, Any], rath: Optional[Rath] = None) -> AsyncIterator[BaseModel]:
